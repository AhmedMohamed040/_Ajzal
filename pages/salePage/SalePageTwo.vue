<template>
  <div class="mt-32 sale-page-two-content">
      ...
      <v-row>
        ...
        >
          <a href="#" class="text-decoration-none">
            ...
            >
              <v-chip class="ma-2 p-absolute top-0 right-0" small> Upto 40% off </v-chip>
    ...
    <div class="sale-page-top-bar">
      <v-tabs v-model="tab" class="sale-page" centered icons-and-text>
        <v-tab href="#tab-0">
          <p class="text-sm mb-0 text-capitalize">Men</p>
          <img
            v-svg-inline
            class="size-28"
            src="@/assets/images/icons/t-shirt.svg"
            alt=""
          />
        </v-tab>
        <v-tab href="#tab-1">
          ...
          <img
            v-svg-inline
            class="size-28"
            src="@/assets/images/icons/women-dress.svg"
            alt=""
          />
        </v-tab>
        ...
        <v-tab href="#tab-2">
          ...
          <img
            v-svg-inline
            class="size-28"
            src="@/assets/images/icons/beauty-products.svg"
            alt=""
          />
        </v-tab>
        <v-tab href="#tab-3">
        ...
        <v-tab href="#tab-5">
          ...
          <img
            v-svg-inline
            class="size-28"
            src="@/assets/images/icons/basket-ball.svg"
            alt=""
          />
        </v-tab>
        <v-tab href="#tab-6">
          ...
          <img
            v-svg-inline
            class="size-28"
            src="@/assets/images/icons/wheel.svg"
            alt=""
          />
        </v-tab>
        <v-tab href="#tab-7">
          ...
          <img
            v-svg-inline
            class="size-28"
            src="@/assets/images/icons/drill-machine.svg"
            alt=""
          />
        </v-tab>
        <v-tab href="#tab-7">
          ...
          <img
            v-svg-inline
            class="size-28"
            src="@/assets/images/icons/baby-feeder.svg"
            alt=""
          />
        </v-tab>
      </v-tabs>
