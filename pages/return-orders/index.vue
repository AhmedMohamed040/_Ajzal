          ...
          >
            ...
            <div class="box-container">
              <div class="d-flex align-center mb-5">
                ...
                <h2 class="mb-0">{{ $t('ordersReturn') }}</h2>
              </div>
                  ...
                  <v-row>
                    <v-col v-for="item in props.items" :key="item.id" cols="12">
                      <a href="#" class="text-decoration-none">
                        <base-card class="">
                            <div
                              class="pa-md-4 pa-sm-2 d-sm-flex justify-sm-center align-center flex-nowrap"
                            >
                              <div class="flex-1 d-sm-flex px-4">
                              ...
                              <div class="flex-1  d-sm-flex px-4">
                                <v-row class="d-sm-none ma-0">
                                  ...
                                  <v-col cols="8">
                                    <p v-if="item.warehouse" class="mb-0">
                                      {{ item.warehouse.name}}
                                    </p>
                                    <p v-else class="mb-0">
                                      {{ $t('doesNotExist')}}
                                ...
                                <p v-if="item.warehouse" class="d-sm-flex d-none d-md-flex d-lg-flex d-xl-flex mb-0">
                                  {{ item.warehouse.name }}
                                </p>
                                <p v-else class="d-sm-flex d-none d-md-flex d-lg-flex d-xl-flex mb-0">
                                  {{ $t('doesNotExist') }}
                                </p>
                              ...
                              <div class="flex-1  d-sm-flex px-4">
                                <v-row class="d-sm-none ma-0">
                                  ...
                                  <v-col cols="8">
                                    <p v-if="item.quantity" class="mb-0">
                                      {{ item.quantity }}
                                    </p>
                                    <p v-else class="mb-0">
                                      {{ $t('doesNotExist') }}
                                ...
                                <p v-if="item.quantity" class="d-sm-flex d-none d-md-flex d-lg-flex d-xl-flex mb-0">
                                  {{ item.quantity }}
                                </p>
