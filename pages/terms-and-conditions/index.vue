            ...
            <div class="box-container">
              <div class="d-flex justify-space-between flex-wrap mb-5">
                <div class="d-flex align-center">
                  <v-icon  dark color="blue darken-4 ">mdi-book-alert-outline</v-icon>
                  <h2 class="mb-0 mx-2">{{ $t('terms') }}</h2>
                </div>
              </div>
         <div>
          <v-card  shaped>
...
export default {
  ...
  data() {
    return {
      ...
      Info: [],
      text:  `<p class=' darken-3 '>الشروط والاحكام هنا</p>`,
...
this.$axios
  .$get('/settings/group/TERMS_SETTING')
  .then((r) => {
  console.log(r.model)
  this.Info = r.model
