                      ...
                      <a href="#" class="text-decoration-none">
                        <base-card class="">
                          ...
                          >
                            <div>
                              <p class="mb-2">
                                My Product is broken. I need refund
                              </p>
                              <div class="d-flex flex-wrap">
                                ...
                                >
                                <div class="d-flex flex-wrap">
                                  <span class="grey--text text--darken-2 mr-2"
                                    >Oct 12, 2020</span
                                  >
                                  <span class="grey--text text--darken-2"
                                    >Website Problem</span
                                  >
                                </div>
                              </div>
                            </div>
                            <v-btn icon color="grey" :to="localePath({name:'supportTickets-TicketDetails'})">
