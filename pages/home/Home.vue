            ...
            <base-card>
              <v-card-text>
                <v-row>
                  ...
                  >
                    <nuxt-link to="/products">
                      <v-img class="mb-4 card-overlay-item" contain :src="n.img"></v-img>
                    </nuxt-link>
            ...
            <base-card>
              <v-card-text>
                <v-row>
                  ...
                  >
                    <nuxt-link to="/products" class="text-decoration-none">
                      <v-img class="mb-4 br-8 card-overlay-item" contain :src="n.img" />
              ...
              <div v-for="(n, index) in bigDiscounts" :key="index" class="m-5">
                <v-col cols="12">
                  <base-card>
                    <v-card-text>
                      <nuxt-link to="/products" class="text-decoration-none">
                        <v-img class="card-overlay-item mb-2 br-8" :src="n.img"></v-img>
                      </nuxt-link>
                      <nuxt-link to="/products" class="text-decoration-none">
                        <h5 class="grey--text text--darken-4">{{ n.title }}</h5>
                      </nuxt-link>
          ...
          <base-card>
            <v-card-text>
              ...
              >
                ...
                <div class="d-flex align-center grey--text text--lighten-1">|</div>
                <v-tab class="text-capitalize">
        ...
        <v-col cols="12" sm="6" md="4" lg="3" xl="3">
          <base-card card-hover-shadow class="py-48">
            <v-card-text class="d-flex align-center justify-center flex-column">
              ...
              <h4 class="font-600 grey--text text--darken-4 mb-3">Worldwide Delivery</h4>
        ...
        <v-col cols="12" sm="6" md="4" lg="3" xl="3">
          <base-card card-hover-shadow class="py-48">
            <v-card-text class="d-flex align-center justify-center flex-column">
              ...
              <h4 class="font-600 grey--text text--darken-4 mb-3">Safe Payment</h4>
              <v-card-subtitle class="text-center grey--text text--darken-2 pt-0"
                >We offer competitive prices on our 100 million plus product any
                range.</v-card-subtitle
              >
        ...
        <v-col cols="12" sm="6" md="4" lg="3" xl="3">
          <base-card card-hover-shadow class="py-48">
            <v-card-text class="d-flex align-center justify-center flex-column">
              ...
              <h4 class="font-600 grey--text text--darken-4 mb-3">24/7 Support</h4>
              <v-card-subtitle class="text-center grey--text text--darken-2 pt-0"
                >We offer competitive prices on our 100 million plus product any
                range.</v-card-subtitle
              >
